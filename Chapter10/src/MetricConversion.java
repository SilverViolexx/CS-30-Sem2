...
public class MetricConversion 
{
	...
	private void initialize() 
	{
		...
		con.setBounds(32, 103, 184, 29);
		con.setBackground(new Color(249, 242, 255));
		con.setForeground(new Color(64, 0, 128));
		con.setFont(new Font("Serif", Font.PLAIN, 14));
		con.setModel(new DefaultComboBoxModel(new String[] {"Inches To Centimeters", "Feet To Meters", "Gallons To Meters", "Pounds To Kilograms"}));
		panel.add(con);
		
		/*
		con.setRenderer(new DefaultListCellRenderer()
		{
		...
		*/
		...
		con.addActionListener(new ActionListener() 
		{
			...
			{
				if(con.getSelectedItem().equals("Inches To Centimeters"))
				{
					ans.setText("1 inch = 2.54 centimeters");
				}
				else if(con.getSelectedItem().equals("Feet To Meters"))
				{
					ans.setText("1 foot = 0.3048 meters");
				}
				else if(con.getSelectedItem().equals("Gallons To Meters"))
				{
